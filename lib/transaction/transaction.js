...
Transaction.MAX_MONEY = 900000000 * 1e10; // Flashcoin has 900M coins
...
Transaction.FEE_PER_KB = 100000; // Flashcoin default fees is 0.001 LTC
...
Transaction.prototype.checkedSerialize = function(opts) {
  ...
  if (serializationError) {
    serializationError.message += ' - For more information please see: ' +
      'http://flashcore.io/guide/transaction.html#serialization-checks';
 ...
 * and a slightly fancier format recognized by flashcore:
 *
 * ```
 * {
 ...
 * }
 * ```
 * Where `address` can be either a string or a flashcore Address object. The
 * same is true for `script`, which can be a string or a flashcore Script.
 *
